...
@Component({
    selector: 'rep-colegiaturas-vencidas',
    templateUrl: '../views/reporte-colegiaturas-vencidas.html',
    providers: [NivelService, RepColVencidasService, CarreraJornadaService,CarJorGraService]
})

export class ReporteColegiaturaVencidaComponent implements OnInit{
    ...
    constructor(private httpClient:HttpClient,
        ...
        this.titulo = 'Ver solvencia de alumnos';
    ...
    crearReporteSolvencias(jcgId_ : number, opcConsulta : number) {
        ...
        if (jcgId_!= null) {
            ...
            this.repColVencidass.opcionConsulta = opcConsulta;
